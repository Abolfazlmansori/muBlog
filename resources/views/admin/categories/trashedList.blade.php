        ...
        <div class="card-body">
            <div class="table overflow-auto" tabindex="8">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td class="text-center align-middle">{{$trashedCategories->firstItem() + $index}}</td>
                        ...
                        <td class="text-center align-middle">{{ \Hekmatinasser\Verta\Facades\Verta::instance($category->deleted_at)->format("%B %d %y") }}</td>
                    </tr>
                    @endforeach
                </table>
