        ...
        <div class="card-body">
            <div class="table overflow-auto" tabindex="8">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td class="text-center align-middle">{{$trashedUsers->firstItem() + $index}}</td>
                        ...
                        <td class="text-center align-middle">{{ \Hekmatinasser\Verta\Facades\Verta::instance($user->deleted_at)->format("%B %d %y") }}</td>
                    </tr>
                    @endforeach
                </table>
