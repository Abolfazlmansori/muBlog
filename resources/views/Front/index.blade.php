                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{asset('front/img/slider/Woo_Package_New_Bnr1.png')}}" class="d-block w-100 rounded" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{asset('front/img/slider/Woo_Package_New_Bnr2.png')}}" class="d-block w-100 rounded" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 top-slider">
                    <div class="slider-item bg-white rounded p-4">
                        <figure class="position-relative">
                            <img src="{{asset('front/img/blog/youtube.jpg')}}" alt="" class="w-100 rounded">
                            ...
                            <div class="slider-item bg-white rounded p-4">
                                <figure class="position-relative">
                                    <a href="{{route('frontend.article',$article->id)}}">
                                        <img src="{{asset('images/articles/'.$article->image)}}" alt="" class="w-100 rounded">
                                    </a>
                                    <figcaption class="tp_top position-absolute p-4">
    ...
    <section>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="title-box mb-3">
                        <p class="m-0 p-0">مقالات پربازدید</p>
                        <span class="d-block"><a href="#">مشاهده همه</a> <i class="bi bi-arrow-left position-relative"></i></span>
                    </div>
                </div>
                @foreach($last_updated_articles as $article)
